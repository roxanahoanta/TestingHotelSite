...
public class ClassicAppPageTest {
...
//        WebElement roomTitle =wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a[stranslate=\"Standard Suite\"]")));
        WebElement moreInfoButton = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#content > div > div.content-body > div > ul > li:nth-child(3) > div > div.info > div.bottom > button > span")));
